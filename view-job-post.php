...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Internshala</b></span>
    </a>
    ...
    <section id="candidates" class="content-header">
      <div class="container">
        <div class="row">          
          ...
          <div class="col-md-3">
            <div class="thumbnail">
              <img src="assets/img/c-2.png" alt="companylogo">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018-2019 <a href="https://albertbgeorge.github.io">Internshala</a>.</strong> All rights
    reserved.
    </div>
  </footer>
